...
try:
    ...
    from pyspark.sql.types import *  # Includes MapType, StringType, StructType, etc.
    from pyspark.sql.column import Column
    import pyspark.sql.functions as F
    from pyspark.sql.functions import col, lit, when, isnan, isnull, expr, from_json
...
# Additional constants for Spark functions
try:
    # Try to import these from settings if they exist
    from settings import DEBUG_SUBDIRECTORY, RESULTS_OUTPUT_FORMAT, RESULTS_OUTPUT_DELIMITER
except ImportError:
    # Provide sensible defaults
    DEBUG_SUBDIRECTORY = Path("/tmp/spark_debug")
